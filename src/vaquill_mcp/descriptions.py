...
TOOL_DESCRIPTIONS: dict[str, str] = {
    "ask_legal_question": (
        ...
        "| 'cases_only'. Modes: 'standard' (5 credits) or 'deep' (multi-hop, 20 credits). "
    ...
    "search_legal_cases": (
        ...
        "conversational answers, 20 for exhaustive lists. Cost: 1-3 credits. For US case "
        "law, use ask_legal_question with countryCode='US'."
    ),
    "quick_search": (
        ...
        "Best when you need a quick overview rather than detailed results. Cost: 1 credit."
    ),
    "resolve_citation": (
        ...
        "Returns found=false (not an error) when citation cannot be resolved. Cost: 1 credit."
    ),
    "search_cases_by_citation": (
        ...
        "DISTINGUISHED, etc.). Returns up to 50 matching cases with metadata. Cost: 1 credit."
    ),
    "lookup_case": (
    ...
    "get_citation_network": (
        ...
        "a case's legal influence. Cost: 2 credits."
    ),
    "get_pricing": (
    ...
    "search_legislation": (
        ...
        "section numbers, provision type, and PDF links. Cost: 1 credit. "
    ...
    "list_legislation": (
        ...
        "title_desc, or popular. Cost: 1 credit."
    ),
    "search_us_statutes": (
        ...
        "feeds get_us_statute_section_text for full text. Cost: 2 credits."
    ),
    "get_us_statute_section": (
        ...
        "preview a section. Cost: 1 credit."
    ),
    "get_us_statute_section_text": (
        ...
        "statutory language for quotation, drafting, or analysis. Cost: 3 credits."
    ),
}
